...
all_star_a11::all_star_a11(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{

         setPixmap(QPixmap(":/images/players/A(11).png"));
         Heading=qrand()%7;
         Vision=qrand()%7;
         Pace=qrand()%7;
...
void all_star_a11::move()
{
 ...
 if(Game->ContVar->StopA==11) return;
 if(Game->ContVar->Half==1){
