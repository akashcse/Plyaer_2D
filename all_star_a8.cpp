...
all_star_a8::all_star_a8(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{

         setPixmap(QPixmap(":/images/players/A(8).png"));
...
void all_star_a8::move()
{
    ...
    QList<QGraphicsItem *> colliding_items=collidingItems();
         for(int i=0,n=colliding_items.size();i<n;i++){
          ...
          if(Game->ContVar->StopA==8) return;
          if(Game->ContVar->Half==1){
