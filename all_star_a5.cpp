...
all_star_a5::all_star_a5(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{

         setPixmap(QPixmap(":/images/players/A(5).png"));
...
void all_star_a5::move()
{
    ...
    QList<QGraphicsItem *> colliding_items=collidingItems();
         for(int i=0,n=colliding_items.size();i<n;i++){
          ...
          if(Game->ContVar->StopA==5) return;
          if(Game->ContVar->Half==1){
