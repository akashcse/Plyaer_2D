...
all_star_b6::all_star_b6(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{
       setPixmap(QPixmap(":/images/players/B(6).png"));
       Heading=qrand()%7;
       Vision=qrand()%7;
       Pace=qrand()%7;
...
void all_star_b6::move()
{
    ...
    QList<QGraphicsItem *> colliding_items=collidingItems();
        ...
        if(Game->ContVar->StopB==6) return;
        if(Game->ContVar->Half==1){
