...
all_star_b7::all_star_b7(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{
       setPixmap(QPixmap(":/images/players/B(7).png"));
       Heading=qrand()%7;
       Vision=qrand()%7;
       Pace=qrand()%5;
...
void all_star_b7::move()
{
    ...
    QList<QGraphicsItem *> colliding_items=collidingItems();
        ...
        if(Game->ContVar->StopB==7) return;
        if(Game->ContVar->Half==1){
