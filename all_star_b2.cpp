...
all_star_b2::all_star_b2(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{
       setPixmap(QPixmap(":/images/players/B(2).png"));
...
void all_star_b2::move()
{
    ...
    QList<QGraphicsItem *> colliding_items=collidingItems();
         ...
         if(Game->ContVar->StopB==2) return;
         if(Game->ContVar->Half==1){
