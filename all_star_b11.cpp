...
all_star_b11::all_star_b11(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{
       setPixmap(QPixmap(":/images/players/B(11).png"));
       Heading=qrand()%7;
       Vision=qrand()%7;
       Pace=rand()%7;
       Accelarlation=rand()%7;
       Stamina=rand()%100;
       Controler=0;
       Marking=0;
       Decisions=0;
...
void all_star_b11::move()
{
    ...
    QList<QGraphicsItem *> colliding_items=collidingItems();
         ...
         if(Game->ContVar->StopB==11) return;
         if(Game->ContVar->Half==1){
