...
all_star_b3::all_star_b3(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{
       setPixmap(QPixmap(":/images/players/B(3).png"));
       Heading=qrand()%7;
       Vision=qrand()%7;
       Pace=qrand()%7;
...
if(Game->ContVar->StopB==3) return;
if(Game->ContVar->Half==1){
