...
all_star_a9::all_star_a9(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{

         setPixmap(QPixmap(":/images/players/A(9).png"));
...
//                  if(Game->ContVar->Through!=0) Game->ContVar->Through=0;
         ...
         if(Game->ContVar->StopA==9) return;
         if(Game->ContVar->Half==1){
