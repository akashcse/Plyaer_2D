...
all_star_b5::all_star_b5(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{
       setPixmap(QPixmap(":/images/players/B(5).png"));
       Heading=qrand()%7;
       Vision=qrand()%7;
       Pace=qrand()%7;
...
if(Game->ContVar->StopB==5) return;
if(Game->ContVar->Half==1){
