...
all_star_b8::all_star_b8(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{
       setPixmap(QPixmap(":/images/players/B(8).png"));
       Heading=qrand()%7;
       Vision=qrand()%7;
       Pace=qrand()%7;
...
if(Game->ContVar->StopB==8) return;
if(Game->ContVar->Half==1){
