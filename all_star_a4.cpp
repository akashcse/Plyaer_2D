...
all_star_a4::all_star_a4(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{

         setPixmap(QPixmap(":/images/players/A(4).png"));
...
void all_star_a4::move()
{
    ...
    QList<QGraphicsItem *> colliding_items=collidingItems();
         for(int i=0,n=colliding_items.size();i<n;i++){
          ...
          if(Game->ContVar->StopA==4) return;
          if(Game->ContVar->Half==1){
