...
all_star_a3::all_star_a3(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{

         setPixmap(QPixmap(":/images/players/A(3).png"));
...
void all_star_a3::move()
{
    ...
    QList<QGraphicsItem *> colliding_items=collidingItems();
         for(int i=0,n=colliding_items.size();i<n;i++){
          ...
          if(Game->ContVar->StopA==3) return;
          if(Game->ContVar->Half==1){
