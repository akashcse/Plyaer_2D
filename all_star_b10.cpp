...
all_star_b10::all_star_b10(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{
       setPixmap(QPixmap(":/images/players/B(10).png"));
       Heading=qrand()%7;
       Vision=qrand()%7;
       Pace=qrand()%7;
...
if(Game->ContVar->StopB==10) return;
if(Game->ContVar->Half==1){
