...
all_star_a2::all_star_a2(QGraphicsItem *parent):QObject(),QGraphicsPixmapItem(parent)
{

         setPixmap(QPixmap(":/images/players/A(2).png"));
...
void all_star_a2::move()
{
    ...
    QList<QGraphicsItem *> colliding_items=collidingItems();
         for(int i=0,n=colliding_items.size();i<n;i++){
          ...
          if(Game->ContVar->StopA==2) return;
          if(Game->ContVar->Half==1){
